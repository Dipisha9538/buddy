...
class _CommentViewState extends ConsumerState<CommentView> {
  ...
  Future<void> _handleRefresh() async {
    ...
    ref.watch(commentViewModelProvider.notifier).getAllComments(bloodId!);
  }

  @override
  void didChangeDependencies() {
    bloodId = ModalRoute.of(context)!.settings.arguments as String?;
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ref
                            ...
                            .addComment(commentController.text, bloodId!);
