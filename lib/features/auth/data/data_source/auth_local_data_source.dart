...
import 'package:blood_buddy/core/network/local/hive_service.dart';
import 'package:blood_buddy/features/auth/data/model/auth_hive_model.dart';
...
class AuthLocalDataSource {
  ...
  Future<Either<Failure, bool>> loginUser(
    ...
    try {
      ...
      if (users == null) {
        return Left(Failure(error: 'Email or Password is incorrect.'));
      } else {
        return const Right(true);
      }
    } catch (e) {
